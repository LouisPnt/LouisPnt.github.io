...
import MasterCompetences from '@/components/MasterCompetences.vue';
...
<template>
  <div class="font-sans bg-gray-900 text-white">
    ...
    <!-- À Propos -->
    <section ref="sections" id="about" class="min-h-screen flex flex-col items-center px-6 bg-gradient-to-r from-gray-800 to-gray-900 mt-12">
      <div id="particles-js" class="absolute inset-0 z-0"></div>
      
      <!-- Conteneur principal -->
      <div class="relative z-10 flex flex-col items-center text-center space-y-6 mt-6">
        <!-- Photo de profil -->
        ...
        <div class="space-y-4">
          ...
          <p class="text-2xl text-gray-300">Étudiant en Data Science</p>
        </div>

        <!-- Texte d'introduction -->
        <p class="text-lg text-gray-400 max-w-2xl">
          <strong>Passionné</strong> par le développement web et les nouvelles technologies, je suis actuellement en formation pour devenir <strong>data analyst</strong>. Basé à <strong>Nantes</strong> pour les études, je recherche des <strong>opportunités ici</strong> ou à <strong>Toulouse</strong> pour mettre mes <strong>compétences</strong> en pratique et contribuer à des projets pertinents et innovants.
        </p>
    ...
    <!-- Formation -->
    <section ref="sections" id="education" class="min-h-screen flex flex-col items-center px-6 mt-4">
      ...
      <div class="relative w-full max-w-3xl">
        ...
        <div class="relative flex items-center justify-between">
          ...
          <div class="bg-gray-800 p-6 rounded-lg shadow-lg w-5/12 text-left">
            <p class="text-blue-400 font-semibold">2025-2027</p>
            <h3 class="text-2xl font-bold">Master Informatique Mention Data Science</h3>
            <p>Université des Sciences et Techniques - Nantes (44)</p>
          </div>
        </div>
    ...
    <!-- Expérience -->
    <section ref="sections" id="experience" class="min-h-screen flex flex-col items-center px-6 mt-4">
      <h2 class="text-4xl font-bold text-blue-400 mb-8">Expérience Professionnelle</h2>
    
      <div class="w-full max-w-4xl space-y-6">

        <!-- Carte pour l'expérience TIRIS (Stage + Collaboration continue) -->
        <div class="bg-gray-800 p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 flex items-start space-x-6">
          <!-- Logo de Tiris -->
          <img src="/icons/tiris.png" alt="Logo TIRIS" class="w-32 h-32 object-contain bg-white p-2 rounded-lg shrink-0" />
          
          <div class="w-full">
            <div class="flex justify-between items-center mb-1">
              <p class="text-lg text-blue-400 font-semibold">2025 - 2026 : TIRIS</p>
            </div>
            <p class="text-gray-300 text-sm mb-3">Toulouse / Distanciel</p>

            <!-- Post-Stage / Collaboration à distance -->
            <div class="border-l-2 border-blue-400 pl-3 mb-3">
              <p class="text-sm font-semibold text-white">Consultant support technique — Distanciel <span class="text-xs text-gray-400 font-normal">(2025 - 2026)</span></p>
              <p class="text-sm text-gray-400 mt-1">
                Poursuite de la collaboration à distance en assurant la maintenance en tant que soutien à l'équipe.
              </p>
            </div>

            <!-- Stage initial -->
            <div class="border-l-2 border-gray-600 pl-3">
              <p class="text-sm font-semibold text-gray-300">Stage de développement — 5 mois <span class="text-xs text-gray-400 font-normal">(2025)</span></p>
              <p class="text-sm text-gray-400 mt-1">
                Conception et mise en place d'un système de gestion de l'administration (back-office). Travail en autonomie, création de maquettes/graphiques puis réalisation en collaboration avec un développeur externe.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-gray-800 p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 flex items-start space-x-6">
          ...
          <div>
            <p class="text-lg text-blue-400 font-semibold">2024 : Stage de développement (2 mois)</p>
    ...
    <section ref="sections" id="interests" class="min-h-screen flex flex-col items-center px-6 bg-gray-900">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl px-4">
        ...
        <div class="bg-gray-800 p-8 rounded-lg text-center shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105">
          ...
          <p class="text-gray-300">12+ ans de pratique</p>
        </div>
